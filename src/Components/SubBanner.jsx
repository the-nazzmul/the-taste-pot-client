  ...
  return (
    <div className="text-center sub-bg relative">
      ...
      <div className="flex flex-col items-center justify-center p-20 absolute w-full h-full z-20 text-white">
        ...
        <p className="my-12 w-3/4 mx-auto">In Taste Pot, we acknowledge that learning ability depends on age many times. So we are offering age specific cooking courses to provide optimal learning environment to the students.</p>
